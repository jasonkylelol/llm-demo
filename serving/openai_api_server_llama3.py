...
parser.add_argument('--base_model', default="/root/huggingface/models/llama3/llama-3-chinese-8b-instruct-v2", type=str)
...
if torch.backends.mps.is_available():
    ...
    if torch.cuda.is_available():
        ...
        print(f"Using device: cuda:{args.gpus}")
    else:
...
print(f"Loading from: {args.base_model}")
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=8061, workers=1, log_config=log_config)
