...
# MODEL_PATH = "/root/huggingface/models/THUDM/chatglm3-6b-128k/" # not working
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            max_length = gr.Slider(0, 32768, value=1024, step=1.0, label="Maximum length", interactive=True)
            top_p = gr.Slider(0, 1, value=0.65, step=0.01, label="Top P", interactive=True)
            temperature = gr.Slider(0.01, 1, value=0.1, step=0.01, label="Temperature", interactive=True)
...
demo.queue()
demo.launch(server_name="0.0.0.0", server_port=8061, inbrowser=False, share=False)